...
namespace Armazon
{
    ...
    partial void OnCarritoTypeChanged();
		...
		[Association(Name="MetodoDePago_Carrito", Storage="_MetodoDePago", ThisKey="MetodoDePagoID", IsForeignKey=true)]
		...
		[Association(Name="Usuario_Carrito", Storage="_Usuario", ThisKey="UsuarioID", IsForeignKey=true)]
    ...
    partial void OnNombreChanged();
		...
		[Association(Name="Producto_Imagen", Storage="_Producto", ThisKey="ProductoID", IsForeignKey=true)]
    ...
    partial void OnNumeroChanged();
		...
		[Association(Name="MetodoDePago_Carrito", Storage="_Carritos", OtherKey="MetodoDePagoID")]
    ...
    partial void OnPrecioChanged();
		...
		[Association(Name="Producto_Imagen", Storage="_Imagens", OtherKey="ProductoID")]
		...
		[Association(Name="Tienda_Producto", Storage="_Tienda", ThisKey="TiendaID", IsForeignKey=true)]
    ...
    partial void OnUsuarioIDChanged();
		...
		[Association(Name="Usuario_Producto_Tag", Storage="_Usuario", ThisKey="UsuarioID", IsForeignKey=true)]
		public Usuario Usuario
		{
			get
			{
    ...
    partial void OnTipoAPIChanged();
		...
		[Association(Name="Tienda_Producto", Storage="_Productos", OtherKey="TiendaID")]
		public EntitySet<Producto> Productos
		{
			get
			{
    ...
    partial void OnNombreChanged();
		...
		[Association(Name="Usuario_Carrito", Storage="_Carritos", OtherKey="UsuarioID")]
		public EntitySet<Carrito> Carritos
		{
			get
			{
		...
		[Association(Name="Usuario_Producto_Tag", Storage="_Producto_Tags", OtherKey="UsuarioID")]
		public EntitySet<Producto_Tag> Producto_Tags
		{
			get
			{
