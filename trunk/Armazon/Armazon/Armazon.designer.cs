...
namespace Armazon
{
    ...
    partial void OnSubCategoriaIDChanged();
		...
		[Association(Name="SubCategoria_Producto", Storage="_SubCategoria", ThisKey="SubCategoriaID", IsForeignKey=true)]
    ...
    partial void OnCategoriaIDChanged();
		...
		[Association(Name="SubCategoria_Producto", Storage="_Productos", OtherKey="SubCategoriaID")]
