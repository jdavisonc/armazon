...
namespace Armazon.ArmazonWS {
    ...
    public partial class DCProduct : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        private Armazon.ArmazonWS.DCProductAttr[] AttrsField;
        ...
        public Armazon.ArmazonWS.DCProductAttr[] Attrs {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="ArmazonWS.IArmazonWS")]
    public interface IArmazonWS {
        ...
        Armazon.ArmazonWS.DCProduct[] search(string fullText);
        ...
        Armazon.ArmazonWS.DCProduct getProduct(int idProduct);
        ...
        Armazon.ArmazonWS.DCRating[] getRatings(int idProduct);
        ...
        bool CartBuy(string user, Armazon.ArmazonWS.DCCartItem[] items);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public interface IArmazonWSChannel : Armazon.ArmazonWS.IArmazonWS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    public partial class ArmazonWSClient : System.ServiceModel.ClientBase<Armazon.ArmazonWS.IArmazonWS>, Armazon.ArmazonWS.IArmazonWS {
        ...
        public Armazon.ArmazonWS.DCProduct[] search(string fullText) {
            return base.Channel.search(fullText);
        }
        
        public Armazon.ArmazonWS.DCProduct getProduct(int idProduct) {
            return base.Channel.getProduct(idProduct);
        }
        
        public Armazon.ArmazonWS.DCRating[] getRatings(int idProduct) {
            return base.Channel.getRatings(idProduct);
        }
        
        public bool CartBuy(string user, Armazon.ArmazonWS.DCCartItem[] items) {
