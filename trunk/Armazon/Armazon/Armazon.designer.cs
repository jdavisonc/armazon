...
namespace Armazon
{
    ...
    partial void OnMetodoDePagoIDChanged();
		...
		[Association(Name="MetodoDePago1_Vendido", Storage="_MetodoDePago", ThisKey="MetodoDePagoID", OtherKey="MetodoDePagoID", IsForeignKey=true)]
	...
	public abstract partial class MetodoDePago : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnPasswordChanged();
		...
		[Column(Storage="_Numero", DbType="VarChar(50)")]
		...
		[Column(Storage="_Usuario", DbType="VarChar(50)")]
		...
		[Association(Name="MetodoDePago1_Vendido", Storage="_Vendidos", ThisKey="MetodoDePagoID", OtherKey="MetodoDePagoID")]
		public EntitySet<Vendido> Vendidos
		{
			get
			{
