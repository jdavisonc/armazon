...
namespace Armazon
{
    ...
    partial void OnNumeroChanged();
		...
		[Association(Name="MetodoDePago_PayPal", Storage="_PayPal", ThisKey="MetodoDePagoID", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="MetodoDePago_Tarjeta", Storage="_Tarjeta", ThisKey="MetodoDePagoID", IsUnique=true, IsForeignKey=false)]
    ...
    partial void OnMetodoDePagoIDChanged();
		...
		[Association(Name="MetodoDePago_PayPal", Storage="_MetodoDePago", ThisKey="MetodoDePagoID", IsForeignKey=true)]
		public MetodoDePago MetodoDePago
		{
			get
			{
	...
	public partial class SubCategoria_Propiedad : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _SubCategoria_PropiedadID;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnSubCategoria_PropiedadIDChanging(int value);
    partial void OnSubCategoria_PropiedadIDChanged();
    partial void OnSubCategoriaIDChanging(int value);
    partial void OnSubCategoriaIDChanged();
    partial void OnPropiedadIDChanging(int value);
    partial void OnPropiedadIDChanged();
    ...
    partial void OnIsIdentificadorChanged();
		...
		[Column(Storage="_SubCategoria_PropiedadID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int SubCategoria_PropiedadID
		{
			get
			{
				return this._SubCategoria_PropiedadID;
			}
			set
			{
				if ((this._SubCategoria_PropiedadID != value))
				{
					this.OnSubCategoria_PropiedadIDChanging(value);
					this.SendPropertyChanging();
					this._SubCategoria_PropiedadID = value;
					this.SendPropertyChanged("SubCategoria_PropiedadID");
					this.OnSubCategoria_PropiedadIDChanged();
				}
			}
		}
		
		[Column(Storage="_SubCategoriaID", DbType="Int NOT NULL")]
		public int SubCategoriaID
		{
			get
			{
		...
		[Column(Storage="_PropiedadID", DbType="Int NOT NULL")]
		public int PropiedadID
		{
			get
			{
    ...
    partial void OnMetodoDePagoIDChanged();
		...
		[Association(Name="MetodoDePago_Tarjeta", Storage="_MetodoDePago", ThisKey="MetodoDePagoID", IsForeignKey=true)]
		public MetodoDePago MetodoDePago
		{
			get
			{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnValorIDChanging(int value);
    partial void OnValorIDChanged();
    partial void OnProductoIDChanging(int value);
    partial void OnProductoIDChanged();
    partial void OnPropiedadIDChanging(int value);
    partial void OnPropiedadIDChanged();
    ...
    partial void OnValor1Changed();
		...
		[Column(Storage="_ValorID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ValorID
		{
			get
			{
				return this._ValorID;
			}
			set
			{
				if ((this._ValorID != value))
				{
					this.OnValorIDChanging(value);
					this.SendPropertyChanging();
					this._ValorID = value;
					this.SendPropertyChanged("ValorID");
					this.OnValorIDChanged();
				}
			}
		}
